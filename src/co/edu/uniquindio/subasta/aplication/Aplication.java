...
public class Aplication extends Application {
	 ...
	 * ---> Pulir - Ver como agregar anuncios dentro de un usuario y luego ser
	 * leidos al cargar el programa. - Añadir anuncios a la carga de datos y los
	 * método que esto conlleva. -----> 50/50 - Borrar, editar un anuncio. ----> no
	 * fundamental - Implementar la interfaz para ver donde el usuario ha hecho
	 * pujas o mejor los articulos que ha comprado. ---> dificil - Agregar las
	 * verificaciones de la creación de un anuncio. - Ver como solucionar el
	 * problema del valor de algunos articulos cuando su precio es muy alto. - Ver
	 * como implementar hilos en el proyecto. ----> A la hora de que se haga una
	 * copia de seguridad o se guarde el programa posiblemente - Hacer toda la
	 * logica para hacer una puja. - Añadir la logica para agregar una imagen en la
	 * creacion de un anuncio. - Realizar toda la lógica para verificación(agregar
	 * dinero positivo, crear un anuncio, valores de puja, etc). - Ver si es
